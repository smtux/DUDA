...
\end{table}
	...
	Cependant, le niveau de développement des pays développés à significativement une influence (p=4.8\%) sur le nombre de videos vues par les hommes par rapport aux femmes.  
...
Nous allons maintenant utiliser une régression binomiale pour calculer les odds-rations afin de déterminer qui, entre les hommes et les femmes ainsi que des
différents niveaux d'HDI, a davantage de chance de passer l'examen ou la certification dans les 3 versions du MOOC.
Les résultats de cette régression sont retranscrits dans les tableaux 14 et 15.
Ainsi, les individus de l'index HDI TH auraient statistiquement et de manière significative (p-value < 0.5 \%), davantage de chances (odd-ratio = 1.56) 
...
\begin{table}[H]
	...
	\midrule
	Réf Gender homme & & & & \\
	Gender femme & 1.865 & 0.763 & 4.560 & 0.172 \\
	Réf HDI B & & & & \\
	HDI TH & 1.251 & 0.284 & 5.503 & 0.767 \\
	HDI I & 0.0 & 0.000 & inf & 0.999 \\
	\bottomrule
	\end{tabular}
	\caption{OR - CI MOOC V1}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{table}[H]
			...
			\midrule
			Réf Gender homme & & & & \\
			Gender femme & 0.813 & 0.660 & 1.003 & 0.053 \\
			Réf HDI B & & & & \\
			HDI TH & 0.835 & 0.589 & 1.184 & 0.311 \\
			HDI I & 1.062 & 0.647 & 1.741 & 0.813 \\
			\bottomrule
			\end{tabular}
			\caption{OR - CI MOOC V3}
			\end{table}
