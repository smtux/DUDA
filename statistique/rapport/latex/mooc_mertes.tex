...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|r|r|r|}
		\hline
		\multicolumn{4}{|c|}{\textbf{ODDS-RADIO}}\\
		\hline
		\multicolumn{1}{|c|}{\textbf{coef}}&
		...
		\hline
		Gender[T.femme]&	1.865&	1.021&	0.813\\
		Réf (homme/HDI B)&	0.003&	0.439&	1.268\\
		New\_HDI[T.I]&		0.0&	1.046&	1.062\\
		New\_HDI[T.TH]&		1.251&	1.558&	0.835\\
		\hline
	\end{tabular}
	\caption{\textbf{Examen - odds-ratio.}}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|r|r|r|}
		...
		Réf (homme/HDI B)&	0***&	0***&	0.157\\
		New\_HDI[T.I]&		0.999&	0.849&	0.813\\
		New\_HDI[T.TH]&		0.767&	0.004**&	0.311\\
		\hline
	\end{tabular}
	\caption{\textbf{Examen - p-value.}}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|r|r|r|}
		...
		\multicolumn{1}{c|}{\textbf{MOOC V3}}\\
		\hline
		Gender[T.femme]&	[0.763, 4.56]&	[0.851, 1.224]&	[0.66, 1.003]\\
		Réf (homme/HDI B)&	[0.001, 0.011]&	[0.329, 0.587]&	[0.913, 1.762]\\
		New\_HDI[T.I]&		[0.0, inf]&		[0.66, 1.658]&	[0.647, 1.741]\\
		New\_HDI[T.TH]&		[0.284, 5.503]&	[1.149, 2.113]&	[0.589, 1.184]\\
		\hline
	\end{tabular}
		\caption{\textbf{Examen - intervalle de confiance (CI).}}	
\end{table}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{../../graph/forestplot_v2.png}
