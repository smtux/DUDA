...
Ainsi, les individus de l'index HDI I ont statistiquement et de manière très significative (p-value < 0.5 \%), 3.5 fois plus de chances (odd-ratio = 3.55) de passer l'examen ou la certification 
que ceux des autres index.
