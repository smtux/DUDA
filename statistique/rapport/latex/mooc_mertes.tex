...
\begin{figure}[H]
	...
	\captionof{table}{\textbf{Examen selon le genre et HDI - MOOC V1.}}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{../../graph/forestplot_V1_binomiale.png}
	\captionof{table}{\textbf{Examen selon le genre et HDI - MOOC V2.}}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{../../graph/forestplot_V2_binomiale.png}
	\captionof{table}{\textbf{Examen selon le genre et HDI - MOOC V3.}}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{\textbf{Nombre de videos selon le genre et HDI - MOOC V1.}}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{\textbf{Nombre de videos selon le genre et HDI - MOOC V2.}}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{../../graph/forestplot_V2_poisson.png}
	\caption{\textbf{Nombre de videos selon le genre et HDI - MOOC V3.}}
\end{figure}
